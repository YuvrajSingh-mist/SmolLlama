...
model_paths = {
    ...
    "Pretrained": "weights/pretrained/pretrained_model.pt"
}
...
for i in model_paths:
    subprocess.run(["python", "download_model_weight.py", "--token", ACCESS_TOKEN, f"--{i.lower()}"], check=True, capture_output=True, text=True)
...
iface = gr.Interface(
    fn=answer_question,
    inputs=[
        gr.Dropdown(choices=["SFT", "DPO", "Base"], value="SFT", label="Select Model"),
